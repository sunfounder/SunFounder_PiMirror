...
class Text(Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        self.text = ''
        self.textLbl = Message(self, font=('Helvetica', conf.large_text_size), fg="white", bg="black", width=500)
        self.textLbl.pack()
...
class Google_Assistant(object):
    ...
    def process_event(self, event):
        ...
        if event.type == EventType.ON_CONVERSATION_TURN_STARTED:
            ...
            elif status_handler.display_status == 'NEWS':
                print ('News conversation')
                status = self.process_news(event.args['text'])
